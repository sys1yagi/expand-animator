...
public class MainActivity extends AppCompatActivity {
    ...
    private void initContainer2(final ExpandAnimatorManager manager) {
        ...
        findViewById(R.id.add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                container.addView(view, 0, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, 100));
     ...
     *
     * @param triggerId   開閉のトリガとなるViewのidを指定して下さい。このViewはクリックが可能である必要があります。
     * @param containerId 開閉の対象となるViewを指定して下さい。
     * @param key         ExpandAnimatorManagerにputする為のキーを指定して下さい。
     * @param manager     ExpandAnimatorを追加するExpandAnimatorManagerを指定して下さい。
     */
     ...
     *
     * @param v expand/unexpandの対象となるViewを指定して下さい。
